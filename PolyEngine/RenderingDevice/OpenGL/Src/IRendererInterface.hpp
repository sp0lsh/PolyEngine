...
namespace Poly {
	...
	struct SceneView : public BaseObject<>
	{
		...
		PriorityQueue<const MeshRenderingComponent*, DistanceToCameraComparator> TranslucentQueue; // TODO: make translucent and particles one queue with common priority
		PriorityQueue<const ParticleComponent*, DistanceToCameraComparator> ParticleQueue;
		Dynarray<const OrthoMeshRenderingComponent*> OrthoList;
